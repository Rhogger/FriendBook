...
public class AutorDAO {
	...
	public void cadastrarAutor(Autor autor) throws ExceptionDAO {
		String sql = "INSERT INTO autor (nome, status) VALUE (?,?)";

		try {
			connection = new ConnectionMVC().getConnection();
			pStatement = connection.prepareStatement(sql);
			pStatement.setString(1, autor.getNome());
			pStatement.setBoolean(2, autor.getStatus());
			pStatement.execute();
	...
	public ArrayList<Autor> listarAutores(String pesquisa) throws ExceptionDAO {
		String sql = "SELECT * FROM autor WHERE nome like '%" + pesquisa + "%' ORDER BY id";
	...
	public void alterarAutor(Autor autor) throws ExceptionDAO {
		...
		String sql = "UPDATE autor SET nome = '" + nome + "', status = " + status + " WHERE id = " + id;
