...
public class TelaCadastrarEditora extends JFrame {
	...
	public TelaCadastrarEditora(TelaConsultarEditora telaConsultar) {
	...
	public static void main(String args[]) {
		try {
			...
			java.util.logging.Logger.getLogger(TelaCadastrarEditora.class.getName()).log(java.util.logging.Level.SEVERE,
					null, ex);
