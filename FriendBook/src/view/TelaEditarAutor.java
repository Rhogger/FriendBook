...
public class TelaEditarAutor extends JFrame {
	...
	public TelaEditarAutor(TelaConsultarAutor telaConsultar) {
		this.telaConsultarAutor = telaConsultar;
		initComponents();
	}

	public void buscarAutor(Integer id, String nome, boolean status) {
		this.idAutor = id;
	...
	private void initComponents() {
		...
		buttonEditar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					sucesso = autorController.alterarAutor(idAutor, nome, status);
	...
	public static void main(String args[]) {
		try {
			...
			java.util.logging.Logger.getLogger(TelaEditarAutor.class.getName()).log(java.util.logging.Level.SEVERE,
					null, ex);
